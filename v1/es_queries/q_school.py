...
def total_enrollment_informations_by_school_id(school_id):
    ...
    if ElasticSearch().check_index_is_exists(es_enum.INDEX_SCHOOL_ENROLL_INFORMATION):
        rs = ElasticSearch().client.search(
            index=es_enum.INDEX_SCHOOL_ENROLL_INFORMATION, body=query)
...
def address_default_province_name_by_school_id(school_id):
    ...
    if ElasticSearch().check_index_is_exists(es_enum.INDEX_SCHOOL_ENROLL_INFORMATION):
        rs = ElasticSearch().client.search(index=es_enum.INDEX_SCHOOL_ADDRESS, body=query)
        try:
...
def school_info_by_school_id(school_id):
    ...
    rs = ElasticSearch().client.search(index=es_enum.INDEX_SCHOOL, body=query)
    try:
